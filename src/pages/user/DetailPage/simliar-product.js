...
const SimilarProducts = () => {
  const products = [
    { id: 1, name: 'Fresh Lime', price: 38, oldPrice: 45, img: '/assets/images/feedback.jpg' },
    { id: 2, name: 'Chocolate Muffin', price: 28, img: '/assets/images/feedback.jpg' },
    { id: 3, name: 'Burger', price: 21, img: '/assets/images/feedback.jpg' },
    { id: 4, name: 'Fresh Lime', price: 38, oldPrice: 45, img: '/assets/images/feedback.jpg' },
  ];
      ...
      <div className="grid grid-cols-4 gap-10" data-aos="fade-up">
        {products.map((product) => (
          <div key={product.id} className="relative group">
            {/* Product Image */}
            <img className="w-full h-60 object-cover rounded-md" src={product.img} alt={product.name} />
