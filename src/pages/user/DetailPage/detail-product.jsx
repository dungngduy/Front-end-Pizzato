                        ...
                        <div className="flex gap-10 w-full">
                            ...
                            <div className="w-[670px]">
                                <div className="space-y-4">
                                    {/* Stock Status */}
                                    <span className="bg-yellow-400 text-white px-2 py-1 rounded">{product.category.name}</span>
                                    ...
                                    {/* Product Price */}
                                    <div className="text-2xl font-semibold text-gray-900">{formatCurrencyVND(product.price)}</div>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <button onClick={handleAddToCart} className="bg-[#BC9A6C] text-white px-6 py-2 rounded-md hover:bg-[#a47d53] transition duration-300">
                                            Thêm vào giỏ hàng
                                        </button>
                                    </div>
